...
class StatusPage extends BeanModel {
    ...
    /**
     * Parse stored showcase config JSON safely.
     * @returns {object|null} Parsed config
     */
    getPlanaShowcaseConfig() {
        if (!this.plana_showcase_config) {
            return null;
        }

        try {
            return JSON.parse(this.plana_showcase_config);
        } catch (error) {
            return null;
        }
    }
    ...
    async toJSON() {
        return {
            ...
            enableDefaultStatusSort: !!this.default_status_sort_enabled,
            planaShowcaseConfig: this.getPlanaShowcaseConfig(),
        };
    }
