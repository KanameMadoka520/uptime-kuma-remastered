...
const { writeStatusPageSnapshot } = require("../utils/plana-status-page-snapshot");
...
module.exports.statusPageSocketHandler = (socket) => {
    ...
    socket.on("saveStatusPage", async (slug, config, imgDataUrl, publicGroupList, callback) => {
        try {
            ...
            statusPage.default_status_sort_enabled = config.enableDefaultStatusSort !== false;
            statusPage.plana_showcase_config = config.planaShowcaseConfig
                ? JSON.stringify(config.planaShowcaseConfig)
                : null;
            ...
            writeStatusPageSnapshot(statusPage.slug, config, publicGroupList);
